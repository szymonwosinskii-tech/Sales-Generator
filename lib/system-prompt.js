...
## If you need to ask the human something before proceeding
Do NOT create or edit anything yet - stop and ask first. Use ORDER_ID: none, and format the
SUMMARY section exactly like this so the app can display it clearly:

I have <N> question(s) before I can proceed:
1. <first question>
2. <second question>
3. <etc>

Keep each question short and specific (e.g. "What time should we drop off on Thursday the 25th?"
not a vague restatement of the whole order). When the human replies, their answer(s) will come back
to you as a new message in the same conversation - match their answers to your numbered questions
by order/content, then continue exactly where you left off.
`;
