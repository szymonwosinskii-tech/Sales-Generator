...
3. Apply the requested change(s):
   ...
   - Follow the same pricing-from-history and product-matching rules above for any newly added
     items.
4. Report back clearly: what the order looked like before, what you changed, and the order's
   current state after your edit (still using the ORDER_ID / SUMMARY format below).
